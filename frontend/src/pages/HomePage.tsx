  ...
  return (
    <>
      <header className="app-header">
        <div>
          <p className="app-user">Signed in as {user?.email}</p>
          {apiMessage ? <p className="app-api">Backend says: {apiMessage}</p> : null}
          {apiError ? <p className="app-api-error">{apiError}</p> : null}
        </div>
