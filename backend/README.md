...
- **MCP web search:** Parallel Search MCP (`tools/web_search_tools/parallel_web_search.py`) connects over Streamable HTTP to `https://search.parallel.ai/mcp` — free, no API key. Optional `PARALLEL_API_KEY` raises rate limits.
